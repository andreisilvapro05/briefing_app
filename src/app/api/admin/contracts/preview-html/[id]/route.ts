...
/**
 * Pré-visualização INLINE (sem download): preenche o template e devolve o
 * contrato como HTML pra renderizar dentro do painel. Mesma lógica de merge
 * do preview em .docx, mas converte pra HTML com mammoth.
 */
...
export async function POST(
  ...
  try {
    ...
    logServerError("contracts.preview-html.fill", err);
  ...
  try {
    ...
    logServerError("contracts.preview-html.convert", err);
    return errorResponse("html-convert-failed", 500, err);
  }
